...
from models.Co2KnnRegressor import knn_pipeline
from models.Co2RidgeRegressor import rd_pipeline
from models.Co2Svr import svr_rbf_pipeline
...
if __name__ == '__main__':
    ...
    test_rmse_graph['test_rmse'].show()
    test_rmse_graph['avg_test_rmse'].show()
